...
See [Project Types](project-types.md) for the full list of supported frameworks, manual configuration for unsupported languages, and test output parsing details.
