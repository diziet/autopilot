...
_unset_autopilot_vars() {
  unset AUTOPILOT_AUTH_FALLBACK AUTOPILOT_BRANCH_PREFIX \
    ...
    AUTOPILOT_CODER_MODEL AUTOPILOT_FIXER_MODEL AUTOPILOT_MERGER_MODEL \
    AUTOPILOT_REVIEWER_MODEL AUTOPILOT_REVIEWER_MODELS \
    ...
    AUTOPILOT_REVIEWER_CONFIG_DIR AUTOPILOT_SELF_UPDATE_INTERVAL \
    AUTOPILOT_SOFT_PAUSE \
    ...
    AUTOPILOT_TIMEOUT_GH AUTOPILOT_TIMEOUT_MERGER AUTOPILOT_TIMEOUT_MERGE \
    ...
    AUTOPILOT_WORKTREE_CLEANUP_INTERVAL AUTOPILOT_WORKTREE_MAX_AGE \
    AUTOPILOT_WORKTREE_SETUP_CMD AUTOPILOT_WORKTREE_SETUP_OPTIONAL \
    AUTOPILOT_FIXER_RESUME_SESSION AUTOPILOT_IDLE_PULL_INTERVAL \
...
# Save the clean PATH before any test modifications.
_ORIGINAL_PATH="$PATH"
...
# and prepends mocks to PATH. AUTOPILOT defaults are inherited from
# file scope (set once during load, forked into each test subprocess).
_init_test_env() {
